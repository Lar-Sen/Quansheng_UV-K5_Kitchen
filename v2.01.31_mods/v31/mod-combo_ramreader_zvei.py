##COMBO Mod
##051F UART command patch to RAM Reader, Ported to v2.00.31
...
cmd051Fcode = b''
...
if fw[0x0D2C:0x0D2C+8] == b'\xF8\xB5\x04\x46\x38\x48\x00\x78':
    fw[0x0D2C:0x0D2C+70] = cmd051Fcode
