...
c:\python\python.exe utils\qsfirm.py unpack k5_v2.01.31_publish.bin temp\fw.dec.bin
...
c:\python\python.exe utils\qsfirm.py pack temp\fw.dec.bin 2.00.00 k5_v2.01.31_MODDED.bin
